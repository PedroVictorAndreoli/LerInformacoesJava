...
public class AtualizarClientes extends javax.swing.JFrame {
    ...
    private final String filePath = System.getProperty("user.dir")+"\\Arquivos\\clientes.dat";
    private final File file = new File(filePath);
    
    public AtualizarClientes() throws IOException, ClassNotFoundException {
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            Logger.getLogger(AtualizarClientes.class.getName()).log(Level.SEVERE, null, ex);
