...
public class Home extends javax.swing.JFrame {
     ...
     */
    public Home() {
        String filePath = System.getProperty("user.dir")+"\\Arquivos\\clientes.txt";
        ...
        if (!file.exists()) {
            try {
                ...
                writer.write("");
                writer.close();
                System.out.println("Arquivo criado e cabeçalho inserido em " + filePath);
            } catch (IOException e) {
                System.out.println("Ocorreu um erro ao criar o arquivo.");
                e.printStackTrace();
            }
        }
        filePath = System.getProperty("user.dir")+"\\Arquivos\\filmes.txt";
        ...
        filePath = System.getProperty("user.dir")+"\\Arquivos\\locacoes.txt";
        file = new File(filePath);
        if (!file.exists()) {
            try {
                FileWriter writer = new FileWriter(file);
