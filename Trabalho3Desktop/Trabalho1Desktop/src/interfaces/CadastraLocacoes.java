...
public class CadastraLocacoes extends javax.swing.JFrame {
    ...
    public CadastraLocacoes() {
        ...
        try {
            ...
            controllerFilme.CriaConexao();
            DefaultComboBoxModel combo = new DefaultComboBoxModel(controllerFilme.buscaTitulos());
            controllerFilme.FechaConexao();
            combo.setSelectedItem("Selecione um Filme");
            
            EntradaFilme.setModel(combo);
    ...
    private void initComponents() {
        ...
        EntradaFilme.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                EntradaFilmeMouseClicked(evt);
            }
        });
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(EntradaFilme, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
    ...
    private void BtnCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCadastrarActionPerformed
        ...
        if (EntradaCodLocacao.getText().isEmpty() || EntradaDataInicio.getText().isEmpty() || EntradaDataFinal.getText().isEmpty() || EntradaCodCliente.getText().isEmpty() /*|| EntradaFilme.getText().isEmpty()*/){
        ...
        if (res == 0){
            ...
            try {
                ...
                filme.setTitulo(EntradaFilme.getSelectedItem().toString());
                locacao.setFilme(filme);
                controller.CriaConexao();
                controller.Inserir(locacao);
    ...
    private void EntradaFilmeMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_EntradaFilmeMouseClicked
        
    }//GEN-LAST:event_EntradaFilmeMouseClicked
